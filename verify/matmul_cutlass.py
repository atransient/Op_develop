...
from cutlass_op import cutlass_matmul_tensor

dtype = torch.bfloat16
device = "cuda"

A_matrix = torch.randn(8,512,1024,dtype=dtype,device=device)
B_matrix = torch.randn(8,1024,512,dtype=dtype,device=device)
...
cutlass_matmul_tensor(mytensor_A, mytensor_B, mytensor_C)

...
int main()
{
    ...
    Layout layout_A3 = make_layout(make_shape(Int<2>{},Int<5>{}),make_stride(Int<1>{},Int<2>{}));
    Layout layout_B3 = make_layout(make_shape(Int<3>{},Int<4>{}),make_stride(Int<1>{},Int<3>{}));
    ...
    print("\tblocked_product:   ");print(blocked_product(layout_A3,layout_B3));print("\n");
    print("\traked_product  :   ");print(raked_product(layout_A3,layout_B3));print("\n");print("\n");
}